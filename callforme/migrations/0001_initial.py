...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('callforme_contact', (
        ...
        db.send_create_signal('callforme', ['Contact'])

        # Adding model 'Call'
        db.create_table('callforme_call', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['callforme.Contact'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('callforme', ['Call'])


    def backwards(self, orm):
        
        # Deleting model 'Contact'
        db.delete_table('callforme_contact')

        # Deleting model 'Call'
        db.delete_table('callforme_call')
    ...
    models = {
        ...
        'callforme.call': {
            ...
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['callforme.Contact']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
